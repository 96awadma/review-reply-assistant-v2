    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <a
            href="/health"
            className="mt-4 inline-flex items-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white transition hover:bg-brand-600"
          >
            Open Health check →
          </a>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <ol className="mt-2 space-y-1 text-sm text-slate-600">
            <li>0 · Fresh project setup ← you are here</li>
            <li>1 · Deploy to Vercel</li>
            <li>2 · Supabase magic-link login</li>
            <li>3 · Google OAuth connection</li>
